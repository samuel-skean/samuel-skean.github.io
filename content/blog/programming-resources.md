...
- [*Learn Rust with Entirely Too Many Linked Lists*](https://rust-unofficial.github.io/too-many-lists/) by Aria Desires
  {#learn-rust-with-entirely-too-many-linked-lists}
    ...
    I've since used it to try to teach Rust in a small group, and it went well! Some videos of that teaching are [here on youtube](https://www.youtube.com/playlist?list=PLK9aFcPV-ytJI93_ja09k7ie-7pINOXbz), but they're incomplete.
