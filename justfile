...
# Unfortunately, it seems like `just` doesn't support variable substitution within backticks. See https://just.systems/man/en/command-evaluation-using-backticks.html. It seems like the shell function might support this. I haven't tried it. TODO: Try it!
